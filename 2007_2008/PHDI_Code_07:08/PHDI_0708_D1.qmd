...
sum(is.na(PHDI_list_normal_sugar$PHDI_ALL))


summary(PHDI_list_normal_sugar$PHDI_ADDED_SUGAR)
summary(PHDI_list_normal_sugar$PHDI_ADDED_FAT_SAT)
summary(PHDI_list_normal_sugar$PHDI_ADDED_FAT_UNSAT)
summary(PHDI_list_normal_sugar$PHDI_REDPROC_MEAT)
```
...
summary(PHDI_list$PHDI_STARCHY_VEG)
summary(PHDI_list$PHDI_NUTS)
summary(PHDI_list$PHDI_ADDED_SUGAR)
summary
PHDI_list$PHDI_ALL
```

```{r}
names(PHDI_list)[names(PHDI_list) == "RESPONDENTID"] <- "SEQN"
hist(PHDI_list$PHDI_ALL)
sum(is.na(PHDI_list$PHDI_ALL))

df_P <- merge(PHDI_list, F_Glucose[,c ("LBXGLU", "SEQN")], by = "SEQN")
ggplot(df_P, aes(PHDI_ALL, LBXGLU)) + geom_point()

```

## PHDI that takes into account the NAs
...
PHDI_list_Changed = PHDI_V2_changed(merged_list$FPED, merged_list$FPED$SEQN, merged_list$FPED$RIDAGEYR, merged_list$NUTRIENT$DR1TKCAL, merged_list$FPED$DR1T_G_WHOLE_GRAM, merged_list$FPED$DR1T_V_STARCHY_TOTAL_GRAM, merged_list$FPED$DR1T_Total_Veg_without_Starch_Leg, merged_list$FPED$DR1T_Total_Fruit_without_juice, merged_list$FPED$DR1T_D_TOTAL_GRAM, merged_list$FPED$DR1T_Total_Red_Processed_Meat, merged_list$FPED$DR1T_PF_POULT_GRAM, merged_list$FPED$DR1T_PF_EGGS_GRAM, merged_list$FPED$DR1T_Total_Seafood_Sub, merged_list$FPED$DR1T_PF_NUTSDS_GRAM, merged_list$FPED$DR1T_V_LEGUMES_GRAM, merged_list$FPED$DR1T_PF_SOY_GRAM, merged_list$FPED$DR1T_OILS, merged_list$FPED$DR1T_SOLID_FATS, merged_list$FPED$DR1T_ADD_SUGARS_GRAM)

sum(is.na(PHDI_list_Changed$PHDI_ALL))
mean(PHDI_list_Changed$PHDI_ALL)



names(PHDI_list_Changed)[names(PHDI_list_Changed) == "RESPONDENTID"] <- "SEQN"
```
