...
```{r}
Blood_Pressure <- read.xport("~/Documents/Laura/UNI/Master/Master thesis/R_Scripts/MSC_LAURA/2007_2008/Examination_data_07:08/BPX_E.XPT")
Body_Measurements <- read.xport("~/Documents/Laura/UNI/Master/Master thesis/R_Scripts/MSC_LAURA/2007_2008/Examination_data_07:08/BMX_E.XPT")
F_Glucose <- read.xport("~/Documents/Laura/UNI/Master/Master thesis/R_Scripts/MSC_LAURA/2007_2008/Lab_data_07:08/GLU_E.XPT")
TRYGL <- read.xport("~/Documents/Laura/UNI/Master/Master thesis/R_Scripts/MSC_LAURA/2007_2008/Lab_data_07:08/TRIGLY_E.XPT")
HB1AC <- read.xport("~/Documents/Laura/UNI/Master/Master thesis/R_Scripts/MSC_LAURA/2007_2008/Lab_data_07:08/GHB_E.XPT")
```
...
```{r}
PHDI_07_08_D1 <- PHDI_all_D1_Excess
```
...
F_Glucose <- read.xport("~/Documents/Laura/UNI/Master/Master thesis/R_Scripts/MSC_LAURA/2007_2008/Lab_data_07:08/GLU_E.XPT")
TRYGL <- read.xport("~/Documents/Laura/UNI/Master/Master thesis/R_Scripts/MSC_LAURA/2007_2008/Lab_data_07:08/TRIGLY_E.XPT")
CHOL <- read.xport("~/Documents/Laura/UNI/Master/Master thesis/R_Scripts/MSC_LAURA/2007_2008/Lab_data_07:08/TCHOL_E.XPT")
```
...
common_seqn_women <- Reduce(intersect, list(seqn_WaistC_F, seqn_LDL_F, seqn_Syst_BP, seqn_Diast_BP, seqn_Glucose, seqn_Trigly))

# Find common SEQN values for men
common_seqn_men <- Reduce(intersect, list(seqn_WaistC_M, seqn_LDL_M, seqn_Syst_BP, seqn_Diast_BP, seqn_Glucose, seqn_Trigly))

# Display the results
participants_with_Metabolic_syndrome_women <- common_seqn_women
participants_with_Metabolic_syndrome_men <- common_seqn_men

print(participants_with_Metabolic_syndrome_women)
print(participants_with_Metabolic_syndrome_men)
```

## Check Correlation between PHDI-US and PHDI

```{r}
PHDI_0708 <- data.frame(
  SEQN = merged_list$FPED$SEQN,
  Gender = merged_list$FPED$RIAGENDR,
  Age = merged_list$FPED$RIDAGEYR,
  PHDI_0708 = PHDI_all_D1_Excess)
df<- merge(PHDI_0708, PHDI_list_Changed[, c("SEQN", "PHDI_ALL")], by ="SEQN", all.y= T)

ggplot(df, aes(x=PHDI_0708, y=PHDI_ALL)) +
...
hist(df$PHDI_0708)
hist(df$PHDI_ALL)
cor.test(df$PHDI_0708, df$PHDI_ALL)
```
...
```{r}
df<- merge(df, Body_Measurements[, c("SEQN", "BMXWAIST")], by= "SEQN" )
...
### Are there problems with the merging?

```{r}
sum(is.na(Body_Measurements$BMXWAIST))
length(Body_Measurements$BMXWAIST)
summary(Body_Measurements$BMXWAIST)
sum(is.na(df$BMXWAIST))
length(df$BMXWAIST)
```
...
```{r}
#PHDI with waist
ggplot(df, aes(PHDI_07_08_D1, BMXWAIST)) + geom_point(alpha= .2) + geom_smooth()

#PHDI with systolic high blood pressure
ggplot(df, aes(PHDI_07_08_D1, Systolic_mean)) + geom_point(alpha= .2) + geom_smooth()

#PHDI with diastolic high blood pressure
ggplot(df, aes(PHDI_07_08_D1, Diastolic_mean)) + geom_point(alpha= .2) + geom_smooth()

#PHDI with low density lipoprotein LDL
ggplot(df, aes(PHDI_07_08_D1, LBDLDL)) + geom_point(alpha= .2) + geom_smooth()

# PHDI with the Glucose 
ggplot(df, aes(PHDI_07_08_D1, LBXGLU)) + geom_point(alpha= .2) + geom_smooth()

# PHDI with the fasting triglycerides
ggplot(df, aes(PHDI_07_08_D1, LBXTR)) + geom_point(alpha= .2) + geom_smooth()
cor.test(df$PHDI_07_08_D1, df$LBXTR)

#PHDI with HB1Ac
ggplot(df, aes(PHDI_07_08_D1, LBXGH)) + geom_point(alpha= .2) + geom_smooth()
cor.test(df$PHDI_07_08_D1, df$LBXGH)

#PHDI with age
ggplot(df, aes(PHDI_07_08_D1, Age)) + geom_point(alpha= .2) + geom_smooth()
cor.test(df$PHDI_07_08_D1, df$Age)
```
