...
\--\> went through the Food codes list of 2005/2006, checked if free sugars were also scored in the added_sugars variable. If not, the FPED_Ind variable was screened to see if it was even in the data set. If not, nothing else was done. If yes, then the food code was entered into this [website](https://fdc.nal.usda.gov/fdc-app.html#/food-details/2346034/nutrients) to get the nutritional values, respectively the sugar content. Then the FPED_Ind list was screen for the different food codes, to get the the grams consumed of the foods/beverages, and then the sugar content was calculated. After that, the Added_sugar variables was changed for the individual / participant.
