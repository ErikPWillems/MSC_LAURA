...
#check that the SEQN number in the rows_with_food_code are also in the merged_list$FPED, and if so, then the free sugar is added to the sugar varibale in merged_list$FPED
